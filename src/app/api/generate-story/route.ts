...
请返回修改后的完整大纲 JSON：`;
    ...
    const response = await callLLM({
      ...
      maxTokens: (skill === 'branchGenerator' || skill === 'branchComplete' || skill === 'outlineGenerator' || skill === 'editOutline' || skill === 'branchMainline' || skill === 'branchSubline') ? 16384 : (skill === 'chat' ? 4096 : 4096),
      skill,
