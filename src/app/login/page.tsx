    ...
    >
      <div className="w-full max-w-[360px]">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-[10px]" style={{ color: 'var(--text-muted)' }}>或</span>
          <div className="flex-1 h-px" style={{ background: 'var(--border)' }} />
        </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-xl text-sm transition-all active:scale-[0.98] flex items-center justify-center gap-2"
