...
## 写作风格（极重要）
- **像人说话**。禁止华丽空洞的修辞、排比句、"命运"类套话
- 用具体画面代替抽象描写："走廊灯泡一闪一闪"比"不祥的预感笼罩心头"好
- 角色对话要自然口语化，有个性，不要每句都像电影台词
- narration 简洁有力，不堆砌形容词
...
## 写作风格（极重要）
- **像人说话**。禁止"命运的齿轮"、"暗流涌动"、"华丽囚笼"等AI套话
- 用具体、日常的画面描写，不堆砌形容词
- 角色对话要口语化，有个性
- narration 一个画面一句话，简洁有力
